...
['geist','Ghostlike spirit from 2E Ravenloft','','The Geist is the lingering spirit of an individual that persists following a particularly traumatic demise, introduced in the 2E Ravenloft setting.','',''],
...
['orbus','Stunted beholder','','The orbus is a variant of the standard beholder in the 2E Spelljammer setting, either genetically engineered or a stunted and immature form. This unique creature exclusively inhabits the void of space, particularly aboard the tyrant ships belonging to beholder nations.','',''],
...
['elite','A very good monster','','Elite was one of the categories that 4E used in classifying its monsters, being more powerful and worth two regulars in the encounter building formula','',''],
...
['scrab','Insect men from the 2E Dark Sun setting','','Scrabs were small insect humanoids that lived in nests in the desert in the 2E Dark Sun setting','',''],
...
['gryph','1E four-legged eagle that injects its eggs into you','','The Gryph is a 1E creature, a bird the size of an eagle usually with four but up to eight legs. They reproduce injecting tiny eggs into host creatures. Ew. ','',''],
...
['bough','_ Dryad from the 4E Monster Vault','','The Bough Dryad is a shy forest dwelling fey from the 4E Monster Vault','',''],
['avari','Humanoid bat creatures featured in Dragon magazine #101','','Avari are a race of are batlike humanoids native to the Middle Lower Planes, featured in Dragon magazine #101','',''],
...
['woads','Wood _ a guardian plant','','Wood woads are human-sized guardian plants from 3E through 5E, each containing the soul of a creature that gave up its life to eternally perform a given duty','',''],
...
['thoul','A typo or maybe a lost monster ','','A mystery for many years, Thouls were listed in the original DnD rule books but never described, an oversight that remained for several years until 1978. Search up DM Davids interesting blog on this one','',''],
['briar','Thorny Witch','','A Briar Hag is seemingly made of thorns and vines and uses corrupted nature against her enemies','',''],
['horag','A 2E creature resulting from the union of a hill giant and an ogre','','A Horag was a 2E creature resulting from the union of a hill giant and an ogre, a disturbing thought... Featured in the adventure Against the Giants: The Liberation of Geoff','',''],
...
['grass','_ land, a terrain type in DnD','','Grassland is a terrain type in 5E, with specific encounter tables and creatures','',''],
...
['mimir','Norse god of wisdom and knowledge','','Mimir was the Norse god of wisdom and knowledge, with a stat block appearing in Dragon magazine #110','',''],
...
['nixie','Aquatic sprites last seen 3E','','Nixies were an elf-like face of aquatic sprites that first featured in 1E and appeared again in 2E and 3E.','',''],
...
['nymph','Fey creature of indescribable beauty','','The nymph, a fey creature of indescribable beauty, embodies the spirit of natural beauty in tangible form. They dwell in stunning natural landscapes.','',''],
...
['trogs','Shorthand for lizard folk, often referred to as stinkmeat by the duergar','','Trogs (short for troglodytes) are reptilians known for their abhorrent smell and have been featured in every edition of DnD to date. ','',''],
...
['wheep','3E crying undead creature with no eyes','','Wheeps were a 3E undead creature with empty eye sockets and clawed hands and feet, appearing like the raised victims of torture.','',''],
...
['trash','An Otyugh\'s favourite food','','Trash is the home of the Otyugh, as long as that trash contains plenty of offal and carrion','',''],
...
['ghour','3E demon like a cross between an ogre and a minotaur','','The Ghour from 3E was a demon with a physical presence resembling a hybrid of an ogre and a minotaur, a colossal monster standing at a towering height of 20 feet, surpassing both in size.','',''],
...
['thrax','Dark Sun 2E creature that will dehydrate you to death','','Thrax were nasty humanoids from the 2E Dark Sun setting, who would drain you of all of your water using suckers at the ends of their long fingers. Ew.','',''],
...
['facet','Salt creatures from Planescape','','Facets were crystalline beings that collected together to form a single entity, from the Planescape setting.','',''],
...
['skrit','Large carnivorous beetle from the cold deserts of Taladas in 2E Dragonlance','','The Skrit is a large carnivorous beetle from the cold deserts of Taladas in 2E Dragonlance','',''],
['pasha','The leader of the Pook guild in Calimport, the capital of Calimshan.','','Pasha Pook was the leader of the Pook guild in Calimport, the capital of Calimshan in the Forgotten Realms campaign setting.','',''],
['envoy','One of the draft subraces for Warforged during the DnDNext 5E design phase','','Envoy was one of the subraces for the Warforged race during the DnDNext 5E play testing, but was subsequently scrapped in the official 5E ruleset','',''],
...
['plasm','Hideous skeletons composed of fire, water, air or earth originating in the elemental planes','','Plasms are hideous skeletons from 2E and are composed of fire, water, air or earth originating in the elemental planes','',''],
...
['mason','Large stone working wasp','','Enlarged versions of their regular counterparts, giant mason wasps are present throughout Zakhara in the 2E Al Qadim campaign setting, and are considered messengers of the gods and bearers of good fortune.','',''],
...
['pooka','Animal themed shapeshifting fey','','The Pooka were wild shapeshifting fey folk who took animal forms, introduced in the 1E supplement Creature Crucible - Tall Tales of the Wee Folk, released in 1989.','',''],
['manes','Souls of evil creatures that descend to the Lower Planes are transformed into these','','Manes are the souls of evil creatures that have descended to the Lower Planes, the lowest form of demonkind. ','',''],
...
['young','Thank goodness it\'s only a _ dragon','','With a CR10, Young Dragons are still a handful and can cheese unwary adventurers, despite their adolescence','',''],
...
['grist','A four armed gargoyle like creature from 2E','','A Grist was a four armed gargoyle like creature from 2E','',''],
...
['silat','_ Hag, from Al Qadim','','Silats, in magical disguise, are a female race of shapeshifting hags that wander both the wilderness and cities of Zakhara in  the 2E Al-Qadim setting, hunting for sustenance.','',''],
...
['jelly','Ochre _','','An ochre jelly is a yellow slimey ooze that will slide under doors and through cracks in pursuit of creatures to devour.','',''],
...
['neogi','Spider or eel, hard to tell...','','A neogi resembles a large spider with an eel-like neck and head. Capable of poisoning both the body and mind of its targets, it can even dominate entities that possess greater physical strength.','',''],
['which','','','','',''],
['there','','','','',''],
['their','','','','',''],
['about','','','','',''],
