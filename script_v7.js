import { WORDS } from "https://jtathev.github.io/words_v7.js";
import { SUCCESS_WORDS } from "https://jtathev.github.io/success_v7.js";
import { SORRY_WORDS } from "https://jtathev.github.io/sorry_v7.js";
...
function getIndexFromDate(dateIn) {
    ...
    let numNonDndWords = 5758;
    let index = ( dateIn.getTime()  / 86400000 ) - 19731; //19731 is days since 1/1/1970 on Dundle relaunch day 1! 86400000 is ms in 24h
    //if run out of words, loop around the DnD words in the array
    while(index>=len-numNonDndWords){
        index = index-(len-numNonDndWords);
    }
